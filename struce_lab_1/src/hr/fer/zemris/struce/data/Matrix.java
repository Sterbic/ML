...
public class Matrix {
	...
	/**
	 * Vrati dvodimenzijonalno polje podataka matrice
	...
	/**
	 * Izvadi redak matrice kao zasebnu matricu
	 * @param row indeks retka
	 * @return stupcasta matrica
	 */
	public Matrix rowAsMatrix(int row) {
		checkRowIndex(row);
		return new Matrix(Arrays.copyOf(matrix[row], cols));
	}
	...
	/**
	 * Vrati najvecu vrijednost u matrici
	 * @return najveca vrijednost
	 */
